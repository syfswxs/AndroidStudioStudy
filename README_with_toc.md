...
- [<span id="head1"> 安卓大白话笔记</span>](#head2)
	- [<span id="head2"> 工具</span>](#head3)
	- [<span id="head3"> ！必读说明！</span>](#head4)
- [<span id="head4">（一） 使用AndroidStudio的一些小技巧</span>](#head5)
- [<span id="head5"> 代码自动排版快捷键</span>](#head6)
- [<span id="head6"> 自动导入包快捷键</span>](#head7)
- [<span id="head7"> 展开收缩代码快捷键</span>](#head8)
- [<span id="head8"> Toast提示框</span>](#head9)
- [<span id="head9"> finish()的用法</span>](#head10)
- [<span id="head10">（二） 遇到的问题</span>](#head11)
- [<span id="head11">使用equals的时候，可能回事null值的对比参数要放后面，如图  </span>](#head12)
- [<span id="head12">当程序编译没问题，运行的时候又闪退，可以试试clean project</span>](#head13)
- [<span id="head13">（三） 创建工程</span>](#head14)
- [<span id="head14">（四） 实现功能</span>](#head15)
- [<span id="head15"> 实现布局管理器内的view功能（文本显示、按钮、图片等等）</span>](#head16)
	- [<span id="head16"> 显示文本（TextView文本框组件）</span>](#head17)
	- [<span id="head17"> 按钮（Button）</span>](#head18)
	- [<span id="head18"> 输入框（EditText）</span>](#head19)
	- [<span id="head19"> 图片（ImageView）</span>](#head20)
- [<span id="head20">内容的布局  </span>](#head21)
- [<span id="head21"> 数据的传输</span>](#head22)
...
- [内容的布局  ](#head20)
- [ 数据的传输](#head21)
# <span id="head2"><span id="head1"> 安卓大白话笔记</span></span>
使用最大白话的语言描述Android开发中实现的功能，本文略掉Androidstudio的安装教程，需要的可自行百度。
#### <span id="head3"><span id="head2"> 工具</span></span>
* AndroidStudio
#### <span id="head4"><span id="head3"> ！必读说明！</span></span>
...
---    
## <span id="head5"><span id="head4">（一） 使用AndroidStudio的一些小技巧</span></span>
### <span id="head6"><span id="head5"> 代码自动排版快捷键</span></span>
* Ctrl + Alt + L
### <span id="head7"><span id="head6"> 自动导入包快捷键</span></span>
* Alt + Enter
### <span id="head8"><span id="head7"> 展开收缩代码快捷键</span></span>
* 使用Ctrl Shift +或-，就可以展开或收起全部代码。
* Ctrl + 或 - 对当前方法展开或者收起
### <span id="head9"><span id="head8"> Toast提示框</span></span>
* 代码：
```java
...
> 文本也根据需要修改
### <span id="head10"><span id="head9"> finish()的用法</span></span>
* 说明：  
...
---
## <span id="head11"><span id="head10">（二） 遇到的问题</span></span>
### <span id="head12"><span id="head11">使用equals的时候，可能回事null值的对比参数要放后面，如图  </span></span>
![Image](https://github.com/syfswxs/AndroidStudioStudy/blob/master/image/equals%E9%97%AE%E9%A2%98.jpg)
### <span id="head13"><span id="head12">当程序编译没问题，运行的时候又闪退，可以试试clean project</span></span>
![Image](https://github.com/syfswxs/AndroidStudioStudy/blob/master/image/clean%20project.jpg)  
>>>>>>[**【点我回到目录】**](#ml)

---
## <span id="head14"><span id="head13">（三） 创建工程</span></span>
...
---
## <span id="head15"><span id="head14">（四） 实现功能</span></span>
### <span id="head16"><span id="head15"> 实现布局管理器内的view功能（文本显示、按钮、图片等等）</span></span>
#### <span id="head17"><span id="head16"> 显示文本（TextView文本框组件）</span></span>
...
>>>>>>[**【点我回到目录】**](#ml)
#### <span id="head18"><span id="head17"> 按钮（Button）</span></span>
* ##### 添加按钮
...
>可点击源文件参考代码  
>>>>>>[**【点我回到目录】**](#ml)
#### <span id="head19"><span id="head18"> 输入框（EditText）</span></span>
...
>>>>>>[**【点我回到目录】**](#ml)
#### <span id="head20"><span id="head19"> 图片（ImageView）</span></span>
* 图片组件如同文本组件一样在布局管理器之中添加  
* [ImageView(图像视图)](https://www.runoob.com/w3cnote/android-tutorial-imageview.html)  
>>>>>>[**【点我回到目录】**](#ml)

---
### <span id="head21"><span id="head20">内容的布局  </span></span>
